...
public class EnemyAttackKeepStats : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (player != null)
        {
            target = player.GetComponent<PlayerHealthKeepStats>();
            displayDamage = player.GetComponent<DisplayDamage>();
        } 
        
        // target = FindObjectOfType<PlayerHealthKeepStats>();
